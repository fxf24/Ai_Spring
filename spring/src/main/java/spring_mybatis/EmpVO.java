...
public class EmpVO {
	...
	public double getCommission_fct() {
		return commission_fct;
	}
	public void setCommission_fct(double commission_fct) {
		this.commission_fct = commission_fct;
	}
	@Override
